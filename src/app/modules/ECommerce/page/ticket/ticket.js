...
export function TicketPage() {
  ...
  const [tickets, retrieveTicket] = useState([]);
  const [deleteModalIsOpen, setDeleteModal] = useState(false);
  const [updateModal, setUpdateModal] = useState(false);
  const [ticketId, setSelectTicket] = useState("");
  ...
  useEffect(() => {
    axios.get('http://localhost:3001/api/auth/all')
      .then(response => {
        retrieveTicket(response.data.ticket);
      })
      .catch(err => {
        toastForFail("Cannot retrieve ticket");
      });
  }, []);

  const deleteTicket = () => {
    axios.delete("http://localhost:3001/api/auth/" + ticketId)
      .then(
        (response) => {
          ...
          <div className="col">
            ...
            <div className="AddTicket">
              ...
              >
                <Modal.Header closeButton >
                 ...
                 <AddTicket closeAddTicket={setModalIsOpenToFalse} />
              </Modal>
            </div>
            ...
            <div className="updateTicket">
              ...
              >
                ...
                <UpdateTicket closeUpdateTicketModal={setUpdateModalClose} id={ticketId} />
              </Modal>
            </div>
            ...
            <div className="deleteVehicle">
              ...
              >
                ...
                <Modal.Body ><strong>Are you sure you want to delete this Ticket?</strong></Modal.Body>
                <Modal.Footer>
