...
export function SubcategoryPage() {
  ...
  const [subcategories, retrieveSubcategory] = useState([]);
  const [deleteModalIsOpen, setDeleteModal] = useState(false);
  const [updateModal, setUpdateModal] = useState(false);
  const [subcategoryId, setSelectSubcategory] = useState("");
  ...
  useEffect(() => {
    axios.get('http://localhost:3001/api/auth/all')
      .then(response => {
        retrieveSubcategory(response.data.subcategory);
      })
      .catch(err => {
        toastForFail("Cannot retrieve subcategory");
      });
  }, []);

  const deleteSubcategories = () => {
    axios.delete("http://localhost:3001/api/auth/" + subcategoryId)
      .then(
        (response) => {
  ...
  var _rows = subcategories.map(subcategory => {
    var title = subcategory.title;
    var image = subcategory.image;
          ...
          <div className="col">
              ...
              <CardHeader className="border-0">
                <div className="row">
                  <h3 className="mb-0 col-lg-6">
                    <strong>Sub Categories I Details</strong>
                  </h3>
            ...
            <div className="AddSubcategories">
              ...
              >
                <Modal.Header closeButton >
                 ...
                 <AddSubcategories closeAddSubcategory={setModalIsOpenToFalse} />
              </Modal>
            </div>
            ...
            <div className="updateSubcategories">
              ...
              >
                ...
                <UpdateSubcategories closeUpdateSubcategoryModal={setUpdateModalClose} id={subcategoryId} />
              </Modal>
            </div>
            ...
            <div className="deleteVehicle">
              ...
              >
                ...
                <Modal.Body ><strong>Are you sure you want to delete this subcategory 1?</strong></Modal.Body>
                <Modal.Footer>
